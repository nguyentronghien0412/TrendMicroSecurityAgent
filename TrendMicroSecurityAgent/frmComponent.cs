...
namespace TrendMicroSecurityAgent
{
    public partial class frmComponent : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void frmComponent_Load(object sender, EventArgs e)
        {
            ...
            dtData.Columns.Add("Component");
            dtData.Columns.Add("Version");
            dtData.Columns.Add("LastedUpdate");

            dtData.Rows.Add("Virus Scan Engine (64-bit)", "21.600.1005", "");
            dtData.Rows.Add("", "", "");

            gcData.DataSource = dtData;
        }

        private void frmComponent_MouseDown(object sender, MouseEventArgs e)
        {
            if (e.Y > 34)
                return;
        ...
        private void frmComponent_MouseMove(object sender, MouseEventArgs e)
        {
            if (mouseDown && e.Y <= 34)
            {
        ...
        private void frmComponent_MouseUp(object sender, MouseEventArgs e)
        {
            mouseDown = false;
        }
    }
